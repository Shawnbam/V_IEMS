...
@section('content')
    <div class="col-sm-8">
        ...
        <div class="tab-content">
            <section class="row postsiee">
                <div role="tabpanel" class="tab-pane active" id="IEEE">
                    <div class="container-fluid" id="post">
                        @foreach($postsiee as $postiee)
                            <h3>{{ $postiee->title }}</h3>
                            <h5><span class="glyphicon glyphicon-time"></span> Post by {{ $postiee->user->name }}, Sep 27, 2015.</h5>
                            <div class="col-sm-4">
            ...
            <section class="row postsiee">
                <div role="tabpanel" class="tab-pane active" id="ACM">
                    <div class="container-fluid" id="post">
                        @foreach($postsacm as $postacm)
                            <h3>{{ $postacm->title }}</h3>
                            <h5><span class="glyphicon glyphicon-time"></span> Post by {{ $postacm->user->name }}, Sep 27, 2015.</h5>
                            <div class="col-sm-4">
                                <img src="http://eskipaper.com/images/image-2.jpg" class="img-rounded img-responsive" alt="Cinque Terre">
                            </div>
                            <br>
